  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        ...
        <form >
            ...
            <a href="#" className='text-sm hover:underline hover:text-blue-600 '>{"Don't"} have an account ?</a>
            </div>
            <div>
                <button className='btn tracking-widest  block btn-sm mt-2 w-full text-lg bg-white text-blue-600'>Login</button>
            </div>
        </form>
