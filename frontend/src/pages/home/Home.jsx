...
const Home = () => {
	return (
		<div className='h-full sm:h-auto'>
			<h1 className='text-center text-4xl font-bold font-mono mb-10 tracking-widest cursor-pointer shadow-md shadow-blue-600 hover:shadow-lg hover:shadow-blue-600 transition-shadow duration-300'>
				MassChat.com
			</h1>
